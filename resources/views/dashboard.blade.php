    ...
    <div class="row gy-4">
                ...
                <div class="d-flex align-items-end row">
                    <div class="order-2 col-md-6 order-md-1">
                        <div class="card-body">
                            ...
                            <p class="mb-0">You have done <span class="mb-0 h6">68%</span>😎 more sales today.</p>
        ...
        <div class="col-lg-2 col-sm-6">
            <div class="card h-100">
                <div class="pb-0 card-header">
                    ...
                    <span class="mb-2 d-block text-body">Sessions</span>
                </div>
                    ...
                    <div class="col-md-5 col-12 border-start">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="dropdown">
                                    <button class="p-0 btn" type="button" id="totalTransaction"
                        ...
                        <div class="pt-3 card-body">
                            ...
                            <hr class="my-4" />
                            <div class="flex-wrap gap-2 d-flex justify-content-around">
                                <div>
        ...
        <div class="col-md-6 col-xl-4">
            <div class="card h-100">
                ...
                <div class="px-4 py-2 d-flex justify-content-between border-bottom">
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="card h-100">
                        <div class="pb-0 card-header">
                            ...
                            <span class="mb-2 d-block text-body">Total Revenue</span>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <div class="pt-3 mt-4 card-info">
                                ...
                                <div class="mt-1 badge bg-label-secondary rounded-pill">Last Six Month</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="card h-100">
                        <div class="pb-0 card-header">
                            ...
                            <span class="mb-2 d-block text-body">Overview</span>
                        </div>
                        <div class="pt-0 card-body">
            ...
            <div class="card h-100">
                <div class="card-header d-flex justify-content-between">
                    <div class="m-0 card-title">
                        ...
                        <p class="mb-0 text-body">82% Activity Growth</p>
                    </div>
                    <div class="dropdown">
                    ...
                    <div class="mb-2 row">
                        <div class="col-6 d-flex align-items-center">
                            ...
                            <div class="ms-3 d-flex flex-column">
                                <small class="mb-1 text-body">Net Income</small>
                        ...
                        <div class="col-6 d-flex align-items-center">
                            ...
                            <div class="ms-3 d-flex flex-column">
                                <small class="mb-1 text-body">Expense</small>
            ...
            <div class="card h-100">
                ...
                <div class="pt-4 pb-1 card-body">
                    <ul class="mb-0 timeline card-timeline">
                        ...
                        <li class="border-transparent timeline-item timeline-item-transparent">
